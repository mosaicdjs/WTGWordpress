...
$feed_url = 'http://www.auswaertiges-amt.de/SiteGlobals/Functions/RSSFeed/DE/RSSNewsfeed/RSS_Reisehinweise.xml?nn=332604'; 
 
output_rss_feed($feed_url, $max_item_cnt = 500, $show_date = true, $show_description = true, $max_words = 0);
