...
/*
* Template Name: City Images
*/
get_header();
echo '
	<style>img {width:auto; max-width:1200px}</style>
	<div style="width= 1400px; left:0; right:0; margin:0; text-align:center">';
    $file = "https://www.worldtravelguide.net/wp-content/themes/wtg/wtg-data-sync/source-data/cities-full-en.xml";    
    $xml = new DOMDocument();
...
//							echo '<h3>Drupal Hero Image (753x350px)</h3><img src="http://manage.worldtravelguide.net/'.$image_path.'"></p>';
                            ...
                            echo '<h2>'.$caption.'</h2>
                            <img src="http://manage.worldtravelguide.net/'.$originalFile_path.'" alt="'.$caption.'"></p>';
