...
?>
	...
	<table class="form-table">
		<tr class="form-field form-required">
			...
			<td>
			<a class="button" href="edit.php?post_type=newsletter&page=mailster_subscribers&ID=<?php echo intval( $subscriber->ID ) ?>">
...
?>
	...
	<table class="form-table">
		<tr class="form-field form-required">
			...
			<td>
			<a class="button" href="edit.php?post_type=newsletter&page=mailster_subscribers&new&wp_user=<?php echo intval( $user->ID ) ?>&_wpnonce=<?php echo wp_create_nonce( 'mailster_nonce' ); ?>">
